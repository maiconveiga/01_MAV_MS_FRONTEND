...
export async function loginAndGetToken(args: {
  ...
  let data: any = {};
  try { data = text ? JSON.parse(text) : {}; } catch { /* mantém {} */ }
...
export async function collectAlarmsBatch(sessions: Session[]): Promise<AlarmItemUI[]> {
